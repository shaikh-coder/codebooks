    ...
    <footer className="bg-white shadow dark:bg-gray-800">
        <div className="p-4 mx-auto max-w-screen-xl md:flex md:items-center md:justify-between md:p-6">            
            ...
            <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                <Link to="https://www.instagram.com/hmmmmadd/" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                ...
                <Link to="https://github.com/shaikh-coder" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
